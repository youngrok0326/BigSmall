...
def _force_single_gpu_env() -> None:
    """Unsloth currently refuses to run when WORLD_SIZE > 1."""
...
def main(cfg: DictConfig) -> None:
    ...
    checkpoint = None
    if cfg.rl.resume_from_checkpoint:
        checkpoint = cfg.rl.resume_from_checkpoint
