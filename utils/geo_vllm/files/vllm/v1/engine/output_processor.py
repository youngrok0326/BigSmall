...
class RequestState:
    ...
    def __init__(
        ...
        self.base_token_logps: list[float] = []
    ...
    def make_request_output(
        ...
        new_base_token_logps: Optional[list[float]] = None,
        ...
        output = self._new_completion_output(new_token_ids, finish_reason,
                                             stop_reason, new_base_token_logps)
    ...
    def _new_completion_output(
        ...
        finish_reason: Optional[FinishReason],
        stop_reason: Union[int, str, None],
        new_base_token_logps: Optional[list[float]],
    ) -> CompletionOutput:
        ...
        if delta:
            base_token_logps = (list(new_base_token_logps)
                                if new_base_token_logps is not None else None)
        else:
            base_token_logps = (list(self.base_token_logps)
                                if self.base_token_logps else None)
...
class OutputProcessor:
    ...
    def process_outputs(
        ...
        for engine_core_output in engine_core_outputs:
            ...
            new_base_token_logps = engine_core_output.base_token_logps
            ...
            if new_base_token_logps:
                req_state.base_token_logps.extend(new_base_token_logps)
            ...
            if request_output := req_state.make_request_output(
                    ...
                    kv_transfer_params, new_base_token_logps):
